      ...
      <div className="max-w-5xl mx-auto relative z-10">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base text-foreground">
                  For Men: Black Suit and Slacks, White Long sleeves<br />
                  For Women: Formal Dress/Long Gown - Blush Pink, Old Rose
                </p>
              </div>
              <div className="border-t border-primary/30 pt-4">
                ...
                <p className="text-base text-foreground">
                  Formal - Semi Formal Attire<br />
                  Formal Dress<br />
                  Colors: Beige, Champagne, Khaki
                </p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-6 relative z-10">
            {[
              { 
                title: "Ninong/Ninang: Formal Coat & Slacks / Formal Dress", 
                description: "Please dress elegantly for this special occasion.",
                delay: 9.4
              },
              { 
                title: "Guests: Longsleeve / Formal Dress", 
                description: "Elegant and tasteful attire is requested.",
                delay: 9.45
              },
              { 
                title: "No cream, Off-white or white colors", 
