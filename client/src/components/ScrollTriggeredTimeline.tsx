...
const TimelineCard: React.FC<TimelineCardProps> = ({ timelineEvent, i }) => {
    ...
    const getEventDescription = (eventName: string): string => {
        const descriptions: Record<string, string> = {
            "Guest Arrival & Registration": "Welcome! Please check in and find your seat as we prepare for the ceremony.",
            ...
            "Reception & Dinner": "A delicious meal followed by touching speeches from our closest family and friends.",
