...
const FAQSection = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      icon: Clock,
      answer: "Please plan to arrive at The Garden Hive Events Place by 2:30 PM to allow time for seating and registration. The ceremony begins promptly at 3:00 PM. Given Antipolo's location and potential traffic, we recommend leaving early to ensure you arrive comfortably on time. The drive from Metro Manila typically takes 1 to 1.5 hours depending on traffic conditions."
    },
    {
